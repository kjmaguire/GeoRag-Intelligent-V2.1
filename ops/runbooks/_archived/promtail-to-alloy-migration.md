...
| **Operator muscle memory.** Anyone debugging "is Promtail healthy?" needs to learn the Alloy debug endpoints (`/debug/pprof`, `/-/ready`, etc.). | Update `ops/runbooks/_archived/log-retention.md` + add a quick-reference card during migration. |
