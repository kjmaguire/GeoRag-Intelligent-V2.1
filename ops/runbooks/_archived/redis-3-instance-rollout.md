...
# Authority:  ops/runbooks/_archived/redis-topology.md
# =============================================================================
...
# instances. See ops/runbooks/_archived/redis-topology.md and redis-3-instance-rollout.md.
# REDIS_CACHE_HOST=redis-cache
...
- `ops/runbooks/_archived/redis-topology.md` — design rationale (the why)
- `ops/runbooks/_archived/backup-restore.md` — AOF backup procedure for redis-queue
   and redis-sessions
