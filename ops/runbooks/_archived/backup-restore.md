...
If zero jobs are registered, check that the `georag-backup-agent` container is healthy and the Ofelia labels are not disabled. See `ops/runbooks/_archived/service-outage.md §7`.
