...
Existing `ops/runbooks/_archived/retrieval-pipeline.md` covers the upstream
...
- `ops/runbooks/_archived/retrieval-pipeline.md` — upstream retrieval debug.
- `ops/runbooks/_archived/citation-pipeline.md` — citation guards that produce refusals.
