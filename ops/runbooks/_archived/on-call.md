...
`ops/runbooks/_archived/secret-management.md`). The message includes:
...
→ own runbook: `ops/runbooks/_archived/authz-audit-triage.md`
...
- `ops/runbooks/_archived/service-outage.md` — per-service recovery.
- `ops/runbooks/_archived/authz-audit-triage.md` — authz spike investigation.
- `ops/runbooks/_archived/refusal-rate-spike.md` — RAG quality regression triage.
- `ops/runbooks/_archived/deploy-rollback.md` — last-resort revert.
