...
bash ops/runbooks/_archived/backup-restore.md   # follow that runbook
...
- `ops/runbooks/_archived/container-hardening.md` — UID conventions per service.
- `ops/runbooks/_archived/backup-restore.md` — restore from backup procedures.
- `ops/runbooks/_archived/cold-start.md` — full-stack startup checklist.
- `ops/runbooks/_archived/log-retention.md` — Loki + authz_audit retention math.
