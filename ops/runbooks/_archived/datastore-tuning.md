...
which requires the database to be offline. See `ops/runbooks/_archived/neo4j-backup.md`.
...
collection recreation with migration of points. Use the pattern in `ops/runbooks/_archived/qdrant-snapshot.md`
