...
- `ops/runbooks/_archived/migration-rollback.md` — schema rollback if needed.
- `ops/runbooks/_archived/secret-management.md` — env file rollback via SOPS.
- `ops/runbooks/_archived/on-call.md` — escalation path if rollback fails.
- `ops/runbooks/_archived/backup-restore.md` — last resort when rollback can't recover.
