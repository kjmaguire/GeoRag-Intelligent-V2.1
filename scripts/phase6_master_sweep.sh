...
#
# Run every Phase 0 → Phase 6 verifier in dependency order and report the
...
# Verifiers ordered by phase + step. Archived under scripts/_archived/:
#   phase1_step{4,5b,6}     — silver.shadow_runs sunset at Phase 4 Step 6
#   phase2_step{1..5}       — Activepieces sunset at Phase 3 Step 7 (or
#                             superseded by phase3 equivalents using Bearer JWT)
#   phase2_step6            — Activepieces flow flag check
SCRIPTS=(
...
echo
echo "============================================================"
echo "PHASE 0 → PHASE 6 MASTER REGRESSION SWEEP"
echo "============================================================"
