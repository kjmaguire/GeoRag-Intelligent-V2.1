...
#
# Run every Phase 0 → Phase 8 verifier in dependency order. Exit 0
...
# Archived (intentionally excluded): phase1_step{4,5b,6} (shadow_runs
# sunset); phase2_step{1..6} (Activepieces sunset / superseded).
SCRIPTS=(
...
echo
echo "============================================================"
echo "PHASE 0 → PHASE 8 MASTER REGRESSION SWEEP"
echo "============================================================"
