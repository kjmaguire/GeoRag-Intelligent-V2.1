...
#
# Run every Phase 0 → Phase 7 verifier in dependency order and report
# the rolled-up pass count. Exit code 0 only if every verifier reaches
# its declared TOTAL.
# =============================================================================
...
# Archived under scripts/_archived/ (intentionally excluded):
#   phase1_step{4,5b,6}   — silver.shadow_runs sunset at Phase 4 Step 6
#   phase2_step{1..6}     — Activepieces sunset at Phase 3 Step 7 (or
#                           superseded by phase3 equivalents).
SCRIPTS=(
...
echo
echo "============================================================"
echo "PHASE 0 → PHASE 7 MASTER REGRESSION SWEEP"
echo "============================================================"
