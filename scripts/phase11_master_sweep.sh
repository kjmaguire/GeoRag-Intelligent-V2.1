#!/usr/bin/env bash
# =============================================================================
# scripts/phase11_master_sweep.sh
#
# Run every Phase 0 → Phase 11 verifier in dependency order. Exit 0
...
SCRIPTS=(
    ...
    phase10_step1_verify.sh
    phase10_step2_verify.sh
    phase10_step3_verify.sh
    phase10_step4_verify.sh
    phase11_step1_verify.sh
    phase11_step2_verify.sh
    phase11_step3_verify.sh
    phase11_step4_verify.sh
    phase11_step5_verify.sh
)

echo
echo "============================================================"
echo "PHASE 0 → PHASE 11 MASTER REGRESSION SWEEP"
echo "============================================================"
