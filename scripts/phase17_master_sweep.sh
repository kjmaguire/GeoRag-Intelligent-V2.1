#!/usr/bin/env bash
# Phase 0 → Phase 17 master regression sweep.
set -uo pipefail
...
SCRIPTS=(
    ...
    phase17_step1_verify.sh phase17_step2_verify.sh phase17_step3_verify.sh
)

echo
echo "============================================================"
echo "PHASE 0 → PHASE 17 MASTER REGRESSION SWEEP"
echo "============================================================"
