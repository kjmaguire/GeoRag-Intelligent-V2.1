#!/usr/bin/env bash
# =============================================================================
# scripts/phase18_master_sweep.sh
#
# Run every verifier from Phase 0 → Phase 18 and report cumulative
# pass count. Exit 0 only at 100%.
# =============================================================================
