...
#
# Run every Phase 0 → Phase 5 verifier in dependency order and report the
# rolled-up pass count. The exit code is 0 only if every verifier reaches
# its declared TOTAL.
#
# Usage:
#   bash scripts/phase5_master_sweep.sh
# =============================================================================
...
# Verifiers ordered by phase + step. Skipped (archived under
# scripts/_archived/): phase1_step{4,5b,6} (silver.shadow_runs sunset at
# Phase 4 Step 6); phase2_step{1..6} (Activepieces sunset at Phase 3
# Step 7, and phase2_step3-5 were superseded by phase3 equivalents
# that use Bearer-JWT auth + renamed feature flags).
SCRIPTS=(
...
echo
echo "============================================================"
echo "PHASE 0 → PHASE 5 MASTER REGRESSION SWEEP"
echo "============================================================"
