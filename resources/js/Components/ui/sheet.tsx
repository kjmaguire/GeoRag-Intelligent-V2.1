...
const sheetVariants = cva(
  "bg-background fixed z-50 flex flex-col gap-4 border-border shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        right:
