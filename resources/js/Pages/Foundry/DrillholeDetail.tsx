 ...
 * worstSeverity/SectionQaPill helpers) — it was fed by a FastAPI endpoint
 * (`/v1/viz/qa`) that no longer exists; see DrillholeDetailController's
 * docblock. Spatial-confidence + lithology-quality badges are unaffected
 * (Postgres-only, no FastAPI dependency) and are unconditionally shown
 * together now rather than split across two mutually-exclusive banners.
 */
        ...
        <AppLayout>
            ...
            <div className="flex-1 overflow-y-auto" style={{ background: 'var(--bg-0)', color: 'var(--fg-1)' }}>
                <div className="sticky top-0 z-10" style={{ background: 'var(--bg-0)', borderBottom: '1px solid var(--line-1)' }}>
                    ...
                    {(lithology_quality || collar.crs_confidence != null || !!collar.georef_method) && (
                        <div
