"""Phase 35 Step 1 — third slice of R-P15-1. Migrates the
COLON-variant NARRATIVE task profile (document-anchored interpretation /
synthesis from NI 43-101 / publications / Public Geoscience).

Text byte-identical to the previous inline ``_SYSTEM_PROMPT_NARRATIVE_COLON``.
"""
