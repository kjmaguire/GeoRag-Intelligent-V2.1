...
# Phase-2 strict tenancy is a FLAG (audit 2026-06-29), not a hardcoded
# constant — flipping it no longer needs a code change. Default OFF =
# Phase-1 observe-only (fallback to default tenant + counter). Set
# WORKSPACE_STRICT_TENANCY=true to make from_state RAISE
# WorkspaceResolutionError on a missing workspace_id instead of falling
# back — flip it AFTER metrics.WORKSPACE_RESOLUTION_FAILURES shows zero
