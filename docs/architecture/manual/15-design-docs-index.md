...
> **Reconciled 2026-09-07.** This chapter is an index of planning artifacts,
> and its per-document verdicts were already maintained. Corrected here: the
> `trace_logging_design` row's follow-up is done — [Ch 12 §3.3](12-observability.md)
> now covers `silver.query_traces`.
...
| 13 | [shadow_telemetry_sentry_tags.md](../../_archived/shadow_telemetry_sentry_tags.md) | (spec) | **Void** — Sentry removed from the stack 2026-08-28; `app/agent/sentry_tags.py` deleted with it. Spec archived. | Sentry tag taxonomy for shadow-mode telemetry | [Ch 12 §7](12-observability.md) |
