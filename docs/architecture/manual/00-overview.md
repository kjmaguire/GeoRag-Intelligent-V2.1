...
| **§04p PDF stack** | The in-process PDF ingest stack (qpdf, pypdfium2, pdfminer.six, pdfplumber, Azure Document Intelligence, tiled oversized-page reconstruction, Tesseract fallback, Qwen-VL on vLLM). Replaced RAGFlow per [ADR-0002](../../adr/). |
