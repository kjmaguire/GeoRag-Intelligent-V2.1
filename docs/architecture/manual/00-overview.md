...
| **Audit ledger** | Append-only hash-chained audit log in `audit.*` ([docs/audit_ledger_hash_recipe.md](../../audit_ledger_hash_recipe.md)), verified by the `audit_ledger_verify` Hatchet cron at 17:00 UTC daily. |
