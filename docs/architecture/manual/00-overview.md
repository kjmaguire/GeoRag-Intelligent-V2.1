...
| **§04p PDF stack** | The in-process PDF ingest stack (qpdf, pypdfium2, pdfminer.six, pdfplumber, Cohere Parse v5 on Azure AI Foundry, Tesseract fallback, Qwen-VL on vLLM). Replaced RAGFlow per [ADR-0002](../../adr/). |
