...
| ~~`eval_real_rag_nightly`~~ | **REMOVED 09d1d35 (2026-07-27)** — file deleted; the links below pointed at a path that no longer resolves. | — | — | — |
| ~~`evaluate_workspace`~~ | **REMOVED 09d1d35 (2026-07-27)** — file deleted; the links below pointed at a path that no longer resolves. | — | — | — |
