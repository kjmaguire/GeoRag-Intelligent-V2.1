...
**Coverage:** 53 workflows discovered (43 fully typed in+out, 10 with ⚠️ untyped slots). Archived workflows under `_archived/` are listed for completeness.
...
| `index_health_check` | [src/fastapi/app/hatchet_workflows/phase0_agents.py](../../../src/fastapi/app/hatchet_workflows/phase0_agents.py) | `AgentRunInput` | `dict` ⚠️ untyped | decl=L186, in=L111, out=? |
...
| `lineage_walk` | [src/fastapi/app/hatchet_workflows/phase0_agents.py](../../../src/fastapi/app/hatchet_workflows/phase0_agents.py) | `AgentRunInput` | `dict` ⚠️ untyped | decl=L153, in=L111, out=? |
| `llm_incident_diagnosis_run` | [src/fastapi/app/hatchet_workflows/phase0_agents.py](../../../src/fastapi/app/hatchet_workflows/phase0_agents.py) | `AgentRunInput` | `dict` ⚠️ untyped | decl=L271, in=L111, out=? |
| `model_cost_summary_run` | [src/fastapi/app/hatchet_workflows/phase0_agents.py](../../../src/fastapi/app/hatchet_workflows/phase0_agents.py) | `AgentRunInput` | `dict` ⚠️ untyped | decl=L254, in=L111, out=? |
| `model_upgrade_watch_run` | [src/fastapi/app/hatchet_workflows/phase0_agents.py](../../../src/fastapi/app/hatchet_workflows/phase0_agents.py) | `AgentRunInput` | `dict` ⚠️ untyped | decl=L220, in=L111, out=? |
...
| `storage_tiering_run` | [src/fastapi/app/hatchet_workflows/phase0_agents.py](../../../src/fastapi/app/hatchet_workflows/phase0_agents.py) | `AgentRunInput` | `dict` ⚠️ untyped | decl=L169, in=L111, out=? |
| `store_reconciliation_run` | [src/fastapi/app/hatchet_workflows/phase0_agents.py](../../../src/fastapi/app/hatchet_workflows/phase0_agents.py) | `AgentRunInput` | `dict` ⚠️ untyped | decl=L203, in=L111, out=? |
| `support_packet_assemble` | [src/fastapi/app/hatchet_workflows/phase0_agents.py](../../../src/fastapi/app/hatchet_workflows/phase0_agents.py) | `AgentRunInput` | `dict` ⚠️ untyped | decl=L287, in=L111, out=? |
...
| `tenant_isolation_audit` | [src/fastapi/app/hatchet_workflows/phase0_agents.py](../../../src/fastapi/app/hatchet_workflows/phase0_agents.py) | `AgentRunInput` | `dict` ⚠️ untyped | decl=L136, in=L111, out=? |
...
| `vllm_security_check_run` | [src/fastapi/app/hatchet_workflows/phase0_agents.py](../../../src/fastapi/app/hatchet_workflows/phase0_agents.py) | `AgentRunInput` | `dict` ⚠️ untyped | decl=L237, in=L111, out=? |
...
**Coverage:** 94 assets discovered across 11 group_names (94 fully typed return, 0 with ⚠️ untyped return). `MaterializeResult` is Dagster's native typed result envelope — metadata + asset key — so it counts as typed; assets that return `Output[T]` further pin the materialized payload's type.
